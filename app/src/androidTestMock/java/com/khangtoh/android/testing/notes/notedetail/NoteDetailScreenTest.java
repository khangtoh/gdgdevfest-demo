...
package com.khangtoh.android.testing.notes.notedetail;

import com.khangtoh.android.testing.notes.R;
import com.khangtoh.android.testing.notes.data.FakeNotesServiceApiImpl;
import com.khangtoh.android.testing.notes.data.Note;
...
import static com.khangtoh.android.testing.notes.custom.matcher.ImageViewHasDrawableMatcher.hasDrawable;
...
public class NoteDetailScreenTest {
    ...
    private static String NOTE_TITLE = "THIS IS A TEST NOTE TITLE";

    private static String NOTE_DESCRIPTION = "THIS IS A COOL DESCRIPTION FOR THE TEST NOTE!";
